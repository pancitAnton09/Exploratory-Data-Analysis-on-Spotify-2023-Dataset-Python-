...
#### Spotify playlists demonstrated a significant factor in driving track visibility, which holds the highest track counts compared to other platforms. While there is little to no correlation between streams and most musical attributes, tracks with highly danceable and energetic qualities tend to slightly be more popular. Furthermore, those in major keys—especially C# Major also appear to be slightly more in line with trends.
...
* Alex The Analyst - Group By and Aggregate Functions in Pandas. https://youtu.be/VRmXto2YA2I?si=H8ooa0lh3pUoDC5f
* ChatGPT
